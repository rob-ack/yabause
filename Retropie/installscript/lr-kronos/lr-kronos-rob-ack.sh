...
function build_lr-kronos-rob-ack() {
    ...
    md_ret_require="$md_build/yabause/out/src/libretro/libkronos_libretro.so"
}

function install_lr-kronos-rob-ack() {
    md_ret_files=(
        'yabause/out/src/libretro/libkronos_libretro.so'
        'yabause/COPYING'
        'yabause/ChangeLog'
        'yabause/AUTHORS'
        'yabause/README'
...
function configure_lr-kronos-rob-ack() {
    ...
    addEmulator 1 "$md_id" "saturn" "$md_inst/libkronos_libretro.so"
    addSystem "saturn"
}