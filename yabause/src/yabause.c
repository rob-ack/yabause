...
int YabauseInit(yabauseinit_struct *init)
{
  ...
  YabauseSetVideoFormat(VIDEOFORMATTYPE_NTSC); //default video format initialization. another call will follow later 
...
int YabauseQuickLoadGame(void)
{
   ...
   if (memcmp(buffer, "SEGA SEGASATURN", 15) == 0)
   {
      ...
      SH2WriteNotify(CurrentSH2, 0x6002000, blocks<<11);
      ...
      SH2WriteNotify(CurrentSH2, addr, blocks<<11);
